...
<iframe
  ...
  style="border: none; position: absolute; top: 0; left: 0; width: 100vw; height: 100vh; clip: rect(calc(50px * 100vh / 600), calc(600px * 100vw / 700), calc(550px * 100vh / 600), calc(50px * 100vw / 700));"
  frameborder="0"
  scrolling="no"
  data-external="1"
></iframe>
