...
<iframe
  ...
  scrolling="no"
  data-external="1"
  style="clip-path: inset(8.33% 14.29% 8.33% 7.14%); float: left; margin: 0 20px 20px 20px;"
></iframe>
...
::: {.panel-tabset}
## Visualization 1
{{< iframe src="content/24clocktime.html" width="100%" height="500px" data-external="1" >}}
## Visualization 2
{{< iframe src="content/24clocktime.html" width="100%" height="500px" data-external="1" >}}
:::
