...
<iframe
  ...
  scrolling="no"
  data-external="1"
  style="border: none; position: absolute; clip: rect(0px, 800px, 500px, 0px); width: 100%;">
</iframe>
...
<iframe src="./content/24clocktime.html" width="100%" height="500px" data-external="1"></iframe>
