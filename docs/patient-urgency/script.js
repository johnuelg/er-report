...
series.labels.template.propertyFields.disabled = "enabled";
series.ticks.template.propertyFields.disabled = "enabled";
...
// Format labels to show the name and value with a percentage symbol
